...
static inline Clay_Dimensions SDL_MeasureText(Clay_StringSlice text, Clay_TextElementConfig *config,
                                              void *userData)
{
...
SDL_AppResult SDL_AppInit(void **appstate, int argc, char *argv[])
{
    ...
    if (!SDL_CreateWindowAndRenderer("Example Window", 640, 480, 0, &window, &renderer)) {
    ...
    Clay_Arena clayMem = (Clay_Arena){.memory = SDL_malloc(totalMem), .capacity = totalMem};
